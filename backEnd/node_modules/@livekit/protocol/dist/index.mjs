...
const Pagination = /* @__PURE__ */ proto3.makeMessageType(
  "livekit.Pagination",
  () => [
    {
      no: 1,
...
const SIPMediaEncryption = /* @__PURE__ */ proto3.makeEnum(
...
const SIPCallDirection = /* @__PURE__ */ proto3.makeEnum(
